...
function Index(props) {
    ...
    const productArray = useSelector((state)=>state.rootReducer[category]);
        ...
        return (
            <div  className={cx(styles.carousel_item,"card")}>
              ...
              <div className={cx("card-body")}>
                  ...
                  <Link to={`/products/${category}/${product.id}`} class={cx(styles.product_btn,"generic_btn")}>View Details &nbsp;<BsArrowRight className={styles.btn_arrow}/></Link>
              </div>
        </div>
        )
    })
