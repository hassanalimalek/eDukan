...
function Index() {
                    ...
                    <div className={styles.product}>
                        ...
                        <div className={styles.product_description}>
                            ...
                            {product.selectedSize!==0?
                             <h6 >Selected Size: {product.selectedSize}</h6>:null
                            }     
                            <div className={styles.bottomBar}>
                                ...
                                <h6 className={styles.price}>Price : Rs {product.subPrice}</h6>
                            </div>
                          <div className={styles.deleteIcon} onClick={(e)=>deleteProduct(index)}><AiFillDelete/></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    if(cartProducts.length>1){
        return(
            ...
            <div className={styles.productCartMainContainer}>
                <h1>{cartProducts}</h1>
                <div className={styles.totalPrice}>
                    <div className={styles.totalPriceContainer}>
                        ...
                        <div className={styles.orderContainer}>
                            ...
                            <div className={cx(styles.orderContainer_row,styles.lastRow)}>
